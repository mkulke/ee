...
Elm.Main.make = function (_elm) {
   ...
   var _op = {};
   var tileSize = 50;
   var boardSize = tileSize * 2;
   var tile = function (tile) {
      var rotation = function (_p0) {
         var _p1 = _p0;
         var _p2 = _p1.orientation;
         switch (_p2.ctor)
         {case "North": return 0;
            case "East": return 90;
      ...
      var tileRotate = $Graphics$Collage.rotate($Basics.degrees(rotation(tile)));
      var path = function (_p3) {
         var _p4 = _p3;
         var _p5 = _p4.kind;
         switch (_p5.ctor)
         {case "Left": return "/img/left.png";
            case "Right": return "/img/right.png";
            default: return "/img/straight.png";}
      };
      return tileRotate($Graphics$Collage.toForm(A3($Graphics$Element.image,tileSize,tileSize,path(tile))));
   };
   var Tile = F2(function (a,b) {    return {kind: a,orientation: b};});
   ...
   var East = {ctor: "East"};
   var main = function () {
      var offset = $Basics.toFloat(tileSize) / 2;
      return A3($Graphics$Collage.collage,
      boardSize,
      boardSize,
      _U.list([A2($Graphics$Collage.move,{ctor: "_Tuple2",_0: 0 - offset,_1: offset},tile(A2(Tile,Right,West)))
              ,A2($Graphics$Collage.move,{ctor: "_Tuple2",_0: 0 - offset,_1: 0 - offset},tile(A2(Tile,Straight,West)))
              ,A2($Graphics$Collage.move,{ctor: "_Tuple2",_0: offset,_1: offset},tile(A2(Tile,Left,East)))
              ,A2($Graphics$Collage.move,{ctor: "_Tuple2",_0: offset,_1: 0 - offset},tile(A2(Tile,Left,West)))]));
   }();
